 ...
 * 视频详细统计控制器
 */
final class VideoStatController extends AbstractController
{
    ...
    #[Route(path: '/admin/statistics/video-stat/{id}', name: 'admin_statistics_video_stat', methods: ['GET', 'POST', 'PUT'])]
