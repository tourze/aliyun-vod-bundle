 ...
 * 转码任务监控
 *
 * @extends AbstractCrudController<TranscodeTask>
 */
#[AdminCrud(
    routePath: '/aliyun-vod/transcode-task',
    routeName: 'aliyun_vod_transcode_task',
)]
final class TranscodeTaskCrudController extends AbstractCrudController
{
